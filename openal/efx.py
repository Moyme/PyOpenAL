...
alIsEffect.restype = ctypes.c_char
...
alEffectiv.argtypes = [ctypes.c_uint, ctypes.c_int, ctypes.POINTER(ctypes.c_uint)]
...
alIsFilter.restype = ctypes.c_char
...
alIsAuxiliaryEffectSlot.restype = ctypes.c_char
